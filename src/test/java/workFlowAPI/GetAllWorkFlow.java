...
import com.api.test.CreateFormTest;

import io.restassured.RestAssured;
import io.restassured.response.Response;
import utils.ExtentTestNGListener;

public class GetAllWorkFlow extends BaseTest{
	@Test(priority = 1)
	public void verifyGetForm() {
	   ...
	   // String token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..ccCwCUwgwaFZi0_jWNPQpABkfumlUxBmAv3ohj4wcyM";  // Use from login response
	    ...
	    Response response = given()
	            ...
	            .when()
	            .get("/api/Workflow/GetAllWorkflow?PageNumber=10&PageSize=5&SearchTerm=string")   // API URL
	            .then()
